...
let personName2: string = "MuhaMMad zaEEm ALtAf";
...
let newName = personName2
  .trim()
  .split(" ")
  .map((char: string) => char[0].toUpperCase() + char.substr(1).toLowerCase())
  .join(" ");
...
let author: string = "Donald Ervin Knuth";
let quote: string =
...
let author1: string = "Donald Ervin Knuth";
let quote1: string =
  "Programming is the art of telling another human being what one wants the computer to do.";
let message: string = `${author1} once said, "${quote1}"`;
console.log(message);
...
let message2: string = `The sum of two numbers is ${result}`;
console.log(message2);

// Program 2 written by Muhammad Zaeem Altaf on 2024-03-06
// This program calculates the sum of a given number.

let myName: string = "Muhammad Zaeem Altaf";
...
let names: string[] = ["John", "Bob", "Alice"];
...
let names1: string[] = ["John", "Bob", "Alice"];
...
let guestList: string[] = ["Muhammad Ali Jinnah", "Leonardo da Vinci", "Allama Iqbal"]
...
let guestList1: string[] = ["Muhammad Ali Jinnah", "Leonardo da Vinci", "Allama Iqbal"];

for (const guest in guestList1) {
  console.log(
    `Hi Dear ${guestList1[guest]}, \n \t I'd love for you to join me for dinner at my place.I hope you can make it!\n`
  );
}

let randomIndex: number = Math.floor(Math.random() * guestList1.length);
...
let guestList2: string[] = [
  ...
  for (const guest in guestList2) {
    console.log(
      `Hi Dear ${guestList2[guest]}, \n \t I'd love for you to join me for dinner at my place.I hope you can make it!\n`
    );
  }
  
  let randomIndex1: number = Math.floor(Math.random() * guestList2.length);
  ...
  console.log(
    "I found a bigger dinner table so I'd like to invite more guests!\n"
  );
...
let guestList3: string[] = [
  ...
  let randomIndex2: number = Math.floor(Math.random() * guestList3.length);
...
let places: string[] = ["Paris", "Norway", "Tokyo", "Shibuya", "Finland"];
...
let guestList4: string[] = ["Muhammad Ali Jinnah", "Leonardo da Vinci", "Allama Iqbal"]
...
let favoriteFruits: string[] = ["Mango", "Banana", "Strawberry"];
...
let userNames: string[] = ["Admin", "User", "John", "Bob", "Eric"];
...
const currentUsers: string[] = ["john", "alice", "bob", "SARAH", "mike"];
const newUsers: string[] = ["Mike", "sam", "emma", "Sarah", "John"];
...
const pizzas: string[] = ["Pepperoni", "Tikka", "Fagita"]
...
let magicianNames: string[] = ["Samri", "Hamoon", "Nastoor"] 
...
let magicianNames1: string[] = ["Zatanna", "Doctor Strange", "Voldemort"];
...
let magicianNames2: string[] = ["Zatanna", "Doctor Strange", "Voldemort"];
...
const make_great1 = (magicians: string[]) => {
...
let modifiedMagicians: string[] = make_great1(magicianNames2);
...
type CarFeatures = string | number | boolean;
